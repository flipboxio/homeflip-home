      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2">
          <img
            ...
            alt="Company Logo"
            className="aspect-[4.48] object-contain w-[157px] mb-4 brightness-0 invert"
          />
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <a href="tel:+5511999999999" className="text-gray-300 hover:text-white transition-colors text-sm flex items-center gap-2">
                <span>(11) 9999-9999</span>
              </a>
            </li>
            <li>
              <a href="mailto:contato@empresa.com" className="text-gray-300 hover:text-white transition-colors text-sm">
                contato@empresa.com
              </a>
            </li>
            <li>
