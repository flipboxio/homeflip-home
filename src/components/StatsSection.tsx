...
const StatCard: React.FC<StatCardProps> = ({
  ...
  textColor = "text-[#000929]"
    ...
    <div className="flex gap-6">
      <img src={icon} alt={`${title} icon`} className="aspect-[1] object-contain w-16 shrink-0" />
...
export const StatsSection: React.FC = () => {
  return <section className="bg-[rgba(16,10,85,1)] flex w-full flex-col items-center py-[87px] max-md:max-w-full">
      ...
      <div className="w-full max-w-[1104px] mt-16 max-md:max-w-full max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          <div className="w-6/12 max-md:w-full max-md:ml-0">
            <StatCard icon="https://cdn.builder.io/api/v1/image/assets/040fe6f248e241579615f8e023273613/fb9a6f6d14923397af6889e4b7e800979965c912?placeholderIfAbsent=true" title="Visita virtual à casa" description="Você pode se comunicar diretamente com os proprietários e nós lhe forneceremos um tour virtual antes de comprar ou alugar o imóvel." bgColor="bg-white" textColor="text-[#000929]" />
          </div>
          <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
            <StatCard icon="https://cdn.builder.io/api/v1/image/assets/040fe6f248e241579615f8e023273613/51e7b67e70575fdec1e4b219b59ff7e38c6fa44c?placeholderIfAbsent=true" title="Encontre o melhor negócio" description="Navegue por milhares de imóveis, salve seus favoritos e configure alertas de pesquisa para não perder a melhor oferta de imóvel!" bgColor="bg-white" textColor="text-[#000929]" />
          </div>
        </div>
      </div>
